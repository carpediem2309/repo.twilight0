...
ADDON=xbmcaddon.Addon(id='plugin.program.Pluto')
dialog = xbmcgui.Dialog()    
VERSION = "1.0.3"
PATH = "plugin.program.Pluto"

    
def CATEGORIES():
    link = OPEN_URL('https://raw.githubusercontent.com/Twilight0/repo.twilight0/master/plugin.program.Pluto/pointer.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("Pluto Wizard","Downloading ",'', 'Please Wait')
